...
class Connection:
    ...
    @classmethod
    def as_async(cls, filename: str, flags: int = ..., vfs: str | None = None, statementcachesize: int = 100) -> Awaitable[AsyncConnection]:
        """:classmethod:
    ...
    *SQLITE_DENY* or *SQLITE_IGNORE*.
    ...
    def __init__(self, filename: str, flags: int = ..., vfs: str | None = None, statementcachesize: int = 100):
    ...
    def wal_checkpoint(self, dbname: str | None = None, mode: int = ...) -> tuple[int, int]:
...
class AsyncConnection:
    ...
    *SQLITE_DENY* or *SQLITE_IGNORE*.
    ...
    async def wal_checkpoint(self, dbname: str | None = None, mode: int = ...) -> tuple[int, int]:
        """Does a WAL checkpoint.  Has no effect if the database(s) are not in WAL mode.
