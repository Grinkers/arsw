...
:PROPERTIES:
:FILE: apsw/aio.py
:LINES: apsw/aio.py:226-236; src/cursor.c:1738-1749; apsw/tests/aiotest.py:484-517
:CATEGORY: Exception handling
:CONFIDENCE: High
:STATUS: open
:END:

Evidence: The pre-3.12 path reconstructs a captured exception with `exc[0](exc[1]).with_traceback(exc[2])`. For tuples whose value is already a normalized exception instance, `exc[1]` is that instance; constructing a new instance changes its arguments, loses instance state and, on Python 3.11, notes, and can invoke a constructor that raises a different exception. The C prefetch path captures a legacy `(type, value, traceback)` tuple, but does not explicitly normalize it before dispatch, so the Python helper must not assume a normalized instance without ensuring it.
...
:PROPERTIES:
:FILE: apsw/shell.py
:LINES: 80-162,229-230,241-300,347-368
...
*** PY046 [HIGH] --data-size makes compared workloads unequal and run-order-dependent
:PROPERTIES:
:FILE: apsw/speedtest.py
:LINES: 109-139,137-301,303-375,392-454
...
:PROPERTIES:
:FILE: apsw/speedtest.py
:LINES: 25-28,42-55,548-550,595-623
...
- Test: Verify that a non-raising callable causes `assertRaisesRoot(ValueError, ...)` to fail; verify direct and chained exceptions with the expected root type pass, while direct and chained exceptions with the wrong root type fail.


*** PY056 [MEDIUM] Source-order checks omit required adjacent comparisons
:PROPERTIES:
:FILE: apsw/tests/__main__.py
:LINES: 6079-6082,6106-6109,6146-6179,6227-6258
:CATEGORY: test correctness / false confidence
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: apsw/tests/__main__.py
:LINES: 10346-10352,10373
:CATEGORY: test correctness / false confidence
:CONFIDENCE: High
:STATUS: open
:END:

With `APSW_TEST_ITERATIONS=0` or a negative value, the loop does not execute and `sys.exit(exitcode)` at line 10373 raises `UnboundLocalError`. This is a robustness/configuration failure distinct from overwriting an earlier failed status.
...
:PROPERTIES:
:FILE: apsw/tests/__main__.py
:LINES: apsw/tests/__main__.py:470-489,3820,3825; apsw/tests/shelltest.py:63-82,1555
:CATEGORY: test correctness / false confidence
:CONFIDENCE: High
:STATUS: open
:END:

At lines 480–482, the right connection executes `PRAGMA table_info` using `left` rather than `right`. The helper consequently verifies row count and values but not right-hand column names. The affected `__main__.py` calls at lines 3820 and 3825 can miss schema-name preservation regressions. The same copied root exists in `apsw/tests/shelltest.py:74–75`, where the `.autoimport` comparison at line 1555 can similarly accept incorrect imported column names despite matching rows.
...
Line 551 evaluates whether `mapping_file_control["SQLITE_FCNTL_SIZE_HINT"]` equals `SQLITE_FCNTL_SIZE_HINT` and discards the resulting boolean. A future constants-generation mismatch would leave this sanity check green.
...
:LINES: apsw/tests/async_meta.py:257-258; apsw/tests/__main__.py:10312-10318; setup.py:179-187; tools/megatest.py:66-73; tools/coverage.sh:65
:CATEGORY: test correctness / false confidence
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: apsw/tests/async_meta.py
:LINES: 91-104,225-231,257-258,372-377,420-462
:CATEGORY: test correctness / false confidence
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: apsw/tests/async_meta.py
:LINES: 62-64,216-223,257-266,304-306; apsw/aio.py:133-139
:CATEGORY: test correctness / false confidence
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: apsw/tests/fork_checker.py
:LINES: apsw/tests/fork_checker.py:19-23,32-43,144-148; src/apsw.c:537-545,1323-1329
...
:PROPERTIES:
:FILE: apsw/trace.py
:LINES: 108-113, 208-221, 353-365, 368
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: apsw/unicode.py, src/unicode.c, apsw/tests/ftstests.py
:LINES: apsw/unicode.py:397-406; src/unicode.c:1685-1759; apsw/tests/ftstests.py:2459-2521
...
:PROPERTIES:
:FILE: examples/fts.py, apsw/fts5.py, src/apswtypes.py
:LINES: examples/fts.py:607-610,627-637; apsw/fts5.py:243-265; src/apswtypes.py:143-148
:CATEGORY: example correctness / safety
:CONFIDENCE: High
:STATUS: open
:END:
...
:LINES: examples/main.py:65-75,1218-1243; examples/session.py:248-254,489-502; Makefile:74-83; tools/fi.py:780-795
:CATEGORY: example correctness / safety
:CONFIDENCE: High
:STATUS: open
:END:

`examples/main.py` opens or creates `dbfile` at lines 65–75, modifies it extensively, and later opens `myobfudb`, writes it, and unconditionally deletes its pathname at lines 1218–1243.  `examples/session.py` similarly backs up into `alice.db` and `bob.db` at lines 248–254 and creates tables in `diff_demo.db` and attached `other.db` at lines 489–502.  The Makefile and fault-injection tool work around both examples by deleting or rewriting these names, but direct execution remains unprotected.
...
:PROPERTIES:
:FILE: setup.py
:LINES: setup.py:615,678; apsw/tests/__main__.py:3843-3844
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: setup.py
:LINES: setup.py:432-442,541-544; apsw/__init__.pyi:1; Makefile:103-104,153-156; tools/gendocstrings.py:727-741,961
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:LINES: src/apswtypes.py:3-4,9,50,61,89,92,98,137,150,159,163; apsw/__init__.pyi:4-5
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: src/apswtypes.py
:LINES: src/apswtypes.py:203-209; src/async.c:251-259; apsw/tests/async_meta.py:420-449
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: src/apswtypes.py
:LINES: src/apswtypes.py:169-178; src/jsonb.c:815-840
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: src/apswtypes.py
:LINES: src/apswtypes.py:137-141; src/fts.c:534-550,573-580
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: src/apswtypes.py
:LINES: src/apswtypes.py:101-103; src/connection.c:3473-3499,3746-3750; apsw/tests/__main__.py:2810-2830,2832-2845
:CATEGORY: correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
Evidence: `vers["megatest SQLITEVERS"] = convert_to_number(min(megatest.SQLITEVERS))` applies `min()` to version strings. For example, lexical ordering selects `"3.53.10"` before `"3.53.9"`, although `3.53.9` is the lower SQLite version. Current matrix values =3.53.0= through =3.53.4= do not trigger the defect.
...
:LINES: tools/coverageanalyser.py:44-63; src/unicode.c:29-31,2666-2686
:CATEGORY: maintenance-tool correctness
:CONFIDENCE: High
:STATUS: open
:END:
...
:LINES: tools/code2rst.py:31,43-44,56,58,62; tools/genconstants.py:66-68; tools/gendocstrings.py:59-62,73-77
...
:PROPERTIES:
:FILE: tools/code2rst.py, tools/genconstants.py, tools/gendocstrings.py
:LINES: tools/code2rst.py:43-47; tools/genconstants.py:67-71; tools/gendocstrings.py:60-64
...
:LINES: tools/code2rst.py:160-168; Makefile:13-23,100-104
...
:PROPERTIES:
:FILE: tools/code2rst.py
:LINES: tools/code2rst.py:176-180,205-212; src/session.c:2383-2384,2439-2440,2498-2499
...
:LINES: tools/genconstants.py:80,156-160; src/constants.c:226-264,856-884
...
:PROPERTIES:
:FILE: tools/genconstants.py
:LINES: tools/genconstants.py:66-68,71-72; Makefile:2,106-108,120-121
...
:LINES: tools/gendocstrings.py:202-208; src/cursor.c:1244-1249; apsw/__init__.pyi:2798-2807; src/apsw.docstrings:3491-3500
:CATEGORY: documentation generation
:CONFIDENCE: high
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: tools/gendocstrings.py
:LINES: tools/gendocstrings.py:924-926; apsw/__init__.pyi:4533-5377
...
:PROPERTIES:
:FILE: tools/gendocstrings.py
:LINES: 320-355,683-685,959-961,1021-1027,1066-1081
:CATEGORY: generation publication
:CONFIDENCE: high
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: tools/docmissing.py, src/vtable.c, tools/code2rst.py
:LINES: tools/docmissing.py:83-87; src/vtable.c:2179-2214,2821-2824; tools/code2rst.py:224-232
:CATEGORY: documentation checker coverage
:CONFIDENCE: high
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: tools/fi.py
:LINES: 942-948; src/faultinject.c:126-147; src/pyutil.c:17-21,176-213
...
:PROPERTIES:
:FILE: tools/genfaultinject.py, tools/fi.py, src/argparse.c, src/async.c, src/jsonb.c, src/unicode.c, src/util.c
:LINES: tools/genfaultinject.py:88-210,232-258; tools/fi.py:918-929; src/argparse.c:319-370; src/async.c:203-208; src/jsonb.c:883-887; src/unicode.c:1345,1852-1863; src/util.c:168-171
:CATEGORY: fault-injection coverage
:CONFIDENCE: high
:STATUS: open
:END:
...
:LINES: tools/gensqlitedebug.py:155,197,263-267,288-319; src/session.c:1918-1959,2093-2150,2167-2231,2273-2601
...
:LINES: tools/genstrings.py:92-125; Makefile:110-112
:CATEGORY: generated-artifact publication
:CONFIDENCE: high
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: tools/import_enron.py
:LINES: tools/import_enron.py:66-68; tools/import_html.py:23-26
:CATEGORY: maintenance-tool correctness
:CONFIDENCE: high
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: tools/megatest.py
:LINES: 34-35,57-77,94-96,123-129,189-215,284-316
...
The utility converts every reported diagnostic string into a `#define`. SQLite can report `COMPILER=gcc-...`, producing an unquoted `SQLITE_COMPILER` value that is unreliable and generally unusable as a source-level configuration value. The maintained `setup.py` path removes `SQLITE_COMPILER` and cleans up derived mutex-selection macros.
...
:PROPERTIES:
:FILE: tools/types2rst.py, src/apswtypes.py
:LINES: tools/types2rst.py:93-124; src/apswtypes.py:192-200
:CATEGORY: maintenance-tool correctness
:CONFIDENCE: high
:STATUS: open
:END:
...
:PROPERTIES:
:FILE: tools/ucdprops2code.py, src/unicode.c
:LINES: tools/ucdprops2code.py:643-669; src/unicode.c:1542-1567,1598-1630
...
:LINES: tools/ucdprops2code.py:1112-1116,1129-1150; Makefile:281-283
...
:PROPERTIES:
:FILE: tools/ucdprops2code.py
:LINES: 403-419,607-669,687-690,723-728,775-779,1043-1046
...
:PROPERTIES:
:FILE: tools/ucdprops2code.py
:LINES: 1066-1069,1095-1097,1134-1150
...
:PROPERTIES:
:FILE: tools/vend.py
:LINES: 553-574,658-726,973-977; tools/megatest.py:34-35,57-67
...
:PROPERTIES:
:FILE: tools/vend.py
:LINES: 987-988,989-1023,1025-1063; Makefile:117-118
